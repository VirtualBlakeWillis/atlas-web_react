...
describe("notifications", () => {
  ...
  describe("normalizedData", () => {
    it("has the correct result array", () => {
      const resultArray = Object.values(normalizedData.result);
      const expected = [
    ...
    it("has the correct messages entity", () => {
      ...
      expect(normalizedData.entities.messages[messageGuid]).toEqual(expected);
    });
    it("has the correct notifications entity", () => {
      const notificationGuid = "5debd7642e815cd350407777";
      const expected = {
        author: "5debd764f8452ef92346c772",
        context: "3068c575-d619-40af-bf12-dece1ee18dd3",
        id: "5debd7642e815cd350407777"
      }
      expect(normalizedData.entities.notifications[notificationGuid]).toEqual(expected);
    });
  });
});
